...
- **Synchronous**: Every team presents a working MVP, the user evidence behind it, and a pivot or persevere decision. See [project/guidelines.md](project/guidelines.md)
...
- **Asynchronous Content**: None
- **Synchronous**: Final project presentations, first group of teams
...
- **Asynchronous Content**: None
- **Synchronous**: Final project presentations, second group of teams
