...
Each team commits one report per week to **their own team repository**, not to this course repository.
This directory holds the template and the rules.

## Where the report goes, exactly
...
5. Merge it to `main` before 5:00pm Tuesday.

Grading is taken from the commit on `main` at 5:00pm Tuesday.
A push after that does not count for that week.

See [`../project/guidelines.md`](../project/guidelines.md) for the full project description, the user evidence standard, and the grading rubric.
